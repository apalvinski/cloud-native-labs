            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user2') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user2/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user2') {
                    ...
                    openshift.tag("user2/gateway-canary:latest", "user2/gateway:latest")
